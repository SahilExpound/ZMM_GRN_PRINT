CLASS lhc_ZI_GRN_PRINT DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS get_instance_features FOR INSTANCE FEATURES
      IMPORTING keys REQUEST requested_features FOR zi_grn_doc RESULT result.

    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR zi_grn_doc RESULT result.

    METHODS zprint FOR MODIFY
      IMPORTING keys FOR ACTION zi_grn_doc~zprint RESULT result.
  ...
  METHOD zprint.
    ...
    LOOP AT lt_result INTO DATA(lw_result).
      ...
      IF update_line-base64_3 IS NOT INITIAL.
        ...
        READ ENTITIES OF zi_grn_print IN LOCAL MODE  ENTITY zi_grn_doc
...
CLASS lsc_ZI_GRN_PRINT IMPLEMENTATION.
  ...
  METHOD save_modified.
   DATA lo_pfd TYPE REF TO zcl_grn_print_n.
    ...
    IF update-zi_grn_doc IS NOT INITIAL.

      LOOP AT update-zi_grn_doc INTO DATA(ls_data).
